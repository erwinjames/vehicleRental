...
echo htmlentities('Confirmed');
 	...
 	echo htmlentities('Cancelled');
										...
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>&no=<?php echo htmlentities($result->ContactNo);?>&naym=<?php echo htmlentities($result->FullName);?>" onclick="return confirm('Do you really want to Confirm this booking')"> Confirm</a> /
...
if (isset($_REQUEST['naym'])&&($_REQUEST['aeid'])) {
$api = new TextMagicAPI(array(
    "username" => "lowecruz", 
    "password" => "Winston11"
));
$names=$_GET['naym'];
$text = $names." "."Booking Successfully Confirmed";
$to = $_GET['no'];
$phones = array($to);
