...
$sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblbrands.BrandName='$searches'";
$query = $dbh -> prepare($sql);
$query -> bindParam(':searching',$searches, PDO::PARAM_STR);
