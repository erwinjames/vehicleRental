...
{ ?><?php }} ?>
          <ul>
            <li>
              ...
              <div class="contact_info_m">Marigondon Lapu-Lapu City<?php   echo htmlentities($result->Address); ?></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m">jedsocarrental@gmail.com<?php   echo htmlentities($result->EmailId); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m">+63950034164 <?php   echo htmlentities($result->ContactNo); ?></a></div>
            </li>
          </ul>
